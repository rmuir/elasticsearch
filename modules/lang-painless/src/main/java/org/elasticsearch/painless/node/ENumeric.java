...
public final class ENumeric extends AExpression {
    ...
    public ENumeric(int offset, String value, int radix) {
        super(offset);
    ...
    void analyze(Variables variables) {
        if (value.endsWith("d") || value.endsWith("D")) {
            ...
            try {
                ...
                throw error2(new IllegalArgumentException("Invalid long constant [" + value + "]."));
            }
        } else {
            try {
                ...
                throw error2(new IllegalArgumentException("Invalid int constant [" + value + "]."));
            }
        }
    }
