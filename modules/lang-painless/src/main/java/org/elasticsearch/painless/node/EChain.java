        ...
        for (ALink link : links) {
            ...
            if (link == last && link.store) {
                if (cat) {
                    ...
                    writer.writeBinaryInstruction(location, promote, 
                            Definition.DEF_TYPE, Definition.DEF_TYPE, operation); // write the operation instruction for compound assignment
