...
public class SecurityTests extends ElasticsearchTestCase {
    ...
    public void testEnvironmentPaths() throws Exception {
        ...
        assertTrue(policy.implies(domain, new FilePermission(environment.homeFile().toString(), "read,readlink")));
        // config file: read-only
        assertTrue(policy.implies(domain, new FilePermission(environment.configFile().toString(), "read,readlink")));
