 ...
 */
public final class XWordDelimiterFilter extends TokenFilter {
  ...
  static {
      assert Version.LUCENE_47 == org.elasticsearch.Version.CURRENT.luceneVersion : "Remove this once we are on LUCENE_48 - see LUCENE-5111";
  }
   ...
   */
  public XWordDelimiterFilter(Version matchVersion, TokenStream in, byte[] charTypeTable, int configurationFlags, CharArraySet protWords) {
    super(in);
   ...
   * @param protWords If not null is the set of tokens to protect from being delimited
   */
  public XWordDelimiterFilter(Version matchVersion, TokenStream in, int configurationFlags, CharArraySet protWords) {
